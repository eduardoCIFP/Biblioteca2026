...
//</editor-fold>
    ...
    */
     ...
     /**
     * Método para realizar una prórroga a un préstamo ampliando su fechaDev 15 días más
     */
    private static void prorroga() {
     ...
     /**
     * Método para realizar una devolución. Consiste en poner hoy como FechaDev, añadir el préstamo a la colección prestamosHist y eliminarlo de la colección prestamos
     */
...
//</editor-fold>
    ...
    public static int stockLibro(String isbn) throws LibroNoExiste, LibroNoDisponible {
        int pos=buscaIsbn(isbn);
        if (pos==-1)throw new LibroNoExiste ("No existe en esta biblioteca la referencia: " + isbn);
